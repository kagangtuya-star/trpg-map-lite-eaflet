...
export const messages = {
  zh: {
    ...
    'create.defaultCursorUrl': '移动光标',
    'create.pointerCursorUrl': '选中光标',
    ...
    'editor.name': '名称',
    'editor.defaultCursorUrl': '移动光标',
    'editor.pointerCursorUrl': '选中光标',
  ...
  en: {
    ...
    'create.defaultCursorUrl': 'Move cursor',
    'create.pointerCursorUrl': 'Select cursor',
    ...
    'editor.name': 'Name',
    'editor.defaultCursorUrl': 'Move cursor',
    'editor.pointerCursorUrl': 'Select cursor',
